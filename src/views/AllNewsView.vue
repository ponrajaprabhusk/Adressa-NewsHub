...
<template>
  <div class="">
    <h1 class="text-center text-3xl text-blue-950 font-semibold m-3">Global News !!</h1>
        ...
        <div class="w-full max-w-3xl bg-white shadow-lg border border-transparent hover:border-blue-950 rounded-lg my-4">
          <div class="px-6 py-4">
            ...
            <div class="flex justify-between items-center">
              ...
              <a href="article.url" target="_blank" class="bg-blue-800 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded">
                Read More
              </a>
            </div>
          </div>
